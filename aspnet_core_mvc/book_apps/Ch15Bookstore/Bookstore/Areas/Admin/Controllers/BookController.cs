...
namespace Bookstore.Areas.Admin.Controllers
{
    ...
    {
        private IBookRepository bookData { get; set; }
        private IRepository<Author> authorData { get; set; }
        private IRepository<Genre> genreData { get; set; }

        public BookController(IBookRepository bookRep, IRepository<Author> authorRep,
            IRepository<Genre> genreRep) 
        {
            bookData = bookRep;
            authorData = authorRep;
            genreData = genreRep;
        }
